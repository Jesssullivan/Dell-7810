...
let record
    ...
    = { date = "2026-04-26"
      ...
      , serialSeconds = Some 0.022242
      , parallelSeconds = Some 0.002382
      , speedup = Some 9.33753
      , delta = Some 1.86265e-09
      , contractCeiling = "C2"
      , result = ChapelProbe.ProbeResult.pass
      , evidence = [ "data/captures/honey/chapel-host-probe-generic-repeat-2026-04-26-sample-05.txt"
