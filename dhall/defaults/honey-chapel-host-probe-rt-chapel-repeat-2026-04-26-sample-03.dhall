...
let record
    ...
    = { date = "2026-04-26"
      ...
      , serialSeconds = Some 0.023178
      , parallelSeconds = Some 0.002349
      , speedup = Some 9.86718
      , delta = Some 1.86265e-09
      , contractCeiling = "C4-precondition-only"
      , result = ChapelProbe.ProbeResult.pass
      , evidence = [ "data/captures/honey/chapel-host-probe-rt-chapel-repeat-2026-04-26-sample-03.txt" ]
