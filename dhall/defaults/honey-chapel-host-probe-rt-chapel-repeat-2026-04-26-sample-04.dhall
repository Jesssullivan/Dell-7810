...
let record
    ...
    = { date = "2026-04-26"
      ...
      , serialSeconds = Some 0.023715
      , parallelSeconds = Some 0.002302
      , speedup = Some 10.3019
      , delta = Some 1.86265e-09
      , contractCeiling = "C4-precondition-only"
      , result = ChapelProbe.ProbeResult.pass
      , evidence = [ "data/captures/honey/chapel-host-probe-rt-chapel-repeat-2026-04-26-sample-04.txt" ]
