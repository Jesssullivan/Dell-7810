...
let record
    ...
    = { date = "2026-04-26"
      ...
      , serialSeconds = Some 0.025468
      , parallelSeconds = Some 0.001932
      , speedup = Some 13.1822
      , delta = Some 1.86265e-09
      , contractCeiling = "C2"
      , result = ChapelProbe.ProbeResult.pass
      , evidence = [ "data/captures/honey/chapel-host-probe-generic-repeat-2026-04-26-sample-01.txt"
