...
- `honey-public-capture-index-2026-04-26.csv`: raw `honey` capture inventory
  ...
  result.
- `honey-public-capture-index-2026-04-28-candidate.csv`: public-candidate
  branch capture index. It intentionally contains only the header row because
  raw host captures are omitted from the candidate branch by default.
