...
1. Start on safe generic default and record:
   ...
   - preferred helper:
     `just platform-host-characterization-window target=${DELL_7810_TARGET} tag=generic-repeat-2026-04-26 expect_lane=generic smi_samples=3 smi_duration=120 hwlat_duration=120 chapel_samples=5`
