...
- cacheable runner lanes validate tooling and reproducibility
- direct `honey` captures remain the machine-under-test evidence

The concrete runner workflow files are tracked separately from this platform/RT
authority slice.
