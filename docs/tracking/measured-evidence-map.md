...
| `honey` boot device map | measured | [`../platform/honey-boot-device-map-2026-04-26.md`](../platform/honey-boot-device-map-2026-04-26.md), `data/captures/honey/boot-device-map-2026-04-26.txt` | Active ESP and `/boot` are on Micron SATA `/dev/sda`; root `/` is LVM `rl00-root` on Crucial NVMe `/dev/nvme0n1` |
